...
import { TextToImageModel, TextToImageOptions } from '@mediaconduit/mediaconduit/src/media/models/abstracts/TextToImageModel';
import { Image, ImageFormat, TextRole, Text } from '@mediaconduit/mediaconduit/src/media/assets/roles';
import { GenerationPrompt } from '@mediaconduit/mediaconduit/src/media/assets/roles/types/metadata';
